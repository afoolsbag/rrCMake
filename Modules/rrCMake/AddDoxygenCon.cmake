...
function(add_doxygen_con _NAME)
  ...
  if(0 LESS sLen)
    set(vOptVar ${sProjectNameUpper}_${sTrimmedNameUpper}_DOCUMENTATION)
  else()
    set(vOptVar ${sProjectNameUpper}_DOCUMENTATION)
  endif()

  option(${vOptVar} "Build ${sName} documentation." ${DOXYGEN_FOUND})
  if(NOT ${vOptVar})
    return()
  endif()
